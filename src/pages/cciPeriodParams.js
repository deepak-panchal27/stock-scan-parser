...
function CciPeriodParams() {
  ...
  const parameter_name = data.criteria[0].variable['$1'].parameter_name;
  const default_value = data.criteria[0].variable['$1'].default_value;

  return (
    <div className="phone-section">
          <div className="text-left mb-4 margin-btm-10 indicator-header">CCI</div>
